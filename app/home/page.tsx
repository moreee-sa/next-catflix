...
export default async function HomePage() {
  let featured_movie: MovieType | null = null;
  let imageUrl: string = '';
  ...
  try {
    ...
    featured_movie = await res_featured.json();

    try {
      if (!featured_movie) notFound();
      imageUrl = `${APIURL}/backdrop/${featured_movie.backdrop_path}`;
